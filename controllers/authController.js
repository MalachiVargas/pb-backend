...
module.exports.signup_post = async (req, res) => {
    ...
    try {
        ...
        res.cookie('jwt', token, { httpOnly: true, maxAge: maxAge * 1000, sameSite: 'None', secure: true, domain: '.https://elastic-goldstine-4d0e72.netlify.app' });
...
module.exports.logout_get = (req, res) => {
    res.cookie('jwt', '', { httpOnly: true, maxAge: 1, sameSite: 'None', secure: true, domain: '.https://elastic-goldstine-4d0e72.netlify.app' });
